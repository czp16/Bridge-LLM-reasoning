...
from sverl.single_controller.base import WorkerGroup, ResourcePool, ClassWithInitArgs, Worker
...
class RayResourcePool(ResourcePool):
    ...
    def get_placement_groups(self, strategy="STRICT_PACK", name=None):
        ...
        pg_name_prefix = name if name else \
            f"{self.name_prefix}sverl_group_{'_'.join([str(count) for count in self._store])}:"
...
from sverl.single_controller.base.decorator import MAGIC_ATTR
import os
