...
from sverl.third_party import LLM
from sverl.third_party import parallel_state as vllm_ps
from sverl import DataProto
from sverl.utils.torch_functional import (broadcast_dict_tensor, allgather_dict_tensors)
from sverl.protocol import all_gather_data_proto
from sverl.utils.debug import log_gpu_memory_usage
# from sverl.third_party.vllm import vllm_version
...
class FSDPVLLMShardingManager(BaseShardingManager):
    ...
    def __enter__(self):
        ...
        if load_format == 'dtensor':
            from sverl.third_party import load_dtensor_weights
