...
def apply_monkey_patch_to_llama():
    if is_transformers_version_in_range("4.45.0", "4.47.1"):
        ...
        from sverl.models.transformers.llama import llama_flash_attn_forward
        LlamaFlashAttention2.forward = llama_flash_attn_forward
    elif is_transformers_version_in_range("4.48.0", "4.49.0"):
        from transformers.models.llama.modeling_llama import LlamaAttention
        from sverl.models.transformers.llama import llama_attn_forward
...
def apply_monkey_patch_to_qwen2():
    if is_transformers_version_in_range("4.45.0", "4.47.1"):
        ...
        from sverl.models.transformers.qwen2 import qwen2_flash_attn_forward
        Qwen2FlashAttention2.forward = qwen2_flash_attn_forward
    elif is_transformers_version_in_range("4.48.0", "4.49.0"):
        from transformers.models.qwen2.modeling_qwen2 import Qwen2Attention
        from sverl.models.transformers.qwen2 import qwen2_attn_forward
